...
public class TCCAEVAPIProductChangeEventToParty {
    ...
    public String toString() {
        ...
        sb.append(TCCAEVAPIProductChangeEventToParty.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TCCAEVAPIProductChangeEventToParty) == false) {
            return false;
        }
        TCCAEVAPIProductChangeEventToParty rhs = ((TCCAEVAPIProductChangeEventToParty) other);
