...
public class RetrieveCustomerProfileResponse extends BaseResponse {

	private static final long serialVersionUID = 8525764646891801069L;
    ...
    public String toString() {
        ...
        sb.append(RetrieveCustomerProfileResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("status");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RetrieveCustomerProfileResponse) == false) {
            return false;
        }
        RetrieveCustomerProfileResponse rhs = ((RetrieveCustomerProfileResponse) other);
