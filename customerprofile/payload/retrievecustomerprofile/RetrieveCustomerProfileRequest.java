...
public class RetrieveCustomerProfileRequest extends BaseRequest {

	private static final long serialVersionUID = -5737527119654322711L;
    ...
    public String toString() {
        ...
        sb.append(RetrieveCustomerProfileRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RetrieveCustomerProfileRequest) == false) {
            return false;
        }
        RetrieveCustomerProfileRequest rhs = ((RetrieveCustomerProfileRequest) other);
