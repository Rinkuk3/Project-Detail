...
public class RetrieveEnrollmentRequest extends BaseRequest {

	private static final long serialVersionUID = -6346791408497011795L;
    ...
    public String toString() {
        ...
        sb.append(RetrieveEnrollmentRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RetrieveEnrollmentRequest) == false) {
            return false;
        }
        RetrieveEnrollmentRequest rhs = ((RetrieveEnrollmentRequest) other);
