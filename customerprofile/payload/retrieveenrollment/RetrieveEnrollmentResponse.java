...
public class RetrieveEnrollmentResponse extends BaseResponse {

	private static final long serialVersionUID = -5550834154125078248L;
    ...
    public String toString() {
        ...
        sb.append(RetrieveEnrollmentResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("status");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RetrieveEnrollmentResponse) == false) {
            return false;
        }
        RetrieveEnrollmentResponse rhs = ((RetrieveEnrollmentResponse) other);
