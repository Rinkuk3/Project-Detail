...
public class GetKycAcctsInfoRequest extends BaseRequest {

	private static final long serialVersionUID = 857434527842054743L;
    ...
    public String toString() {
        ...
        sb.append(GetKycAcctsInfoRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GetKycAcctsInfoRequest) == false) {
            return false;
        }
        GetKycAcctsInfoRequest rhs = ((GetKycAcctsInfoRequest) other);
