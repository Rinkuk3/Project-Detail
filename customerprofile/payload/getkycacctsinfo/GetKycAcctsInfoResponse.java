...
public class GetKycAcctsInfoResponse extends BaseResponse {

	private static final long serialVersionUID = 7496933763108896648L;
    ...
    public String toString() {
        ...
        sb.append(GetKycAcctsInfoResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("status");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GetKycAcctsInfoResponse) == false) {
            return false;
        }
        GetKycAcctsInfoResponse rhs = ((GetKycAcctsInfoResponse) other);
