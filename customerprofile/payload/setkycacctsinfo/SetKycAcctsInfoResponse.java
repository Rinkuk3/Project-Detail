...
public class SetKycAcctsInfoResponse extends BaseResponse {

	private static final long serialVersionUID = -3233537812113082969L;
    ...
    public String toString() {
        ...
        sb.append(SetKycAcctsInfoResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("status");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SetKycAcctsInfoResponse) == false) {
            return false;
        }
        SetKycAcctsInfoResponse rhs = ((SetKycAcctsInfoResponse) other);
