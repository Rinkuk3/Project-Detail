...
public class SetKycAcctsInfoRequest extends BaseRequest {

	private static final long serialVersionUID = -2330595579990004883L;
    ...
    public String toString() {
        ...
        sb.append(SetKycAcctsInfoRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SetKycAcctsInfoRequest) == false) {
            return false;
        }
        SetKycAcctsInfoRequest rhs = ((SetKycAcctsInfoRequest) other);
