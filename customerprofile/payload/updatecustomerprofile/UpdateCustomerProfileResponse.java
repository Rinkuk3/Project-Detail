...
public class UpdateCustomerProfileResponse extends BaseResponse implements Serializable {

	private static final long serialVersionUID = -8673954003914074602L;
    ...
    public String toString() {
        ...
        sb.append(UpdateCustomerProfileResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("status");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof UpdateCustomerProfileResponse) == false) {
            return false;
        }
        UpdateCustomerProfileResponse rhs = ((UpdateCustomerProfileResponse) other);
