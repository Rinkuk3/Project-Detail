...
public class UpdateCustomerProfileRequest extends BaseRequest implements Serializable {
	
	private static final long serialVersionUID = -2478528624628185873L;
    ...
    public String toString() {
        ...
        sb.append(UpdateCustomerProfileRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof UpdateCustomerProfileRequest) == false) {
            return false;
        }
        UpdateCustomerProfileRequest rhs = ((UpdateCustomerProfileRequest) other);
