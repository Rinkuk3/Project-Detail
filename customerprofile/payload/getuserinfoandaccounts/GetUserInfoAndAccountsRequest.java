...
public class GetUserInfoAndAccountsRequest extends BaseRequest {

	private static final long serialVersionUID = 5420981431605367697L;
    ...
    public String toString() {
        ...
        sb.append(GetUserInfoAndAccountsRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GetUserInfoAndAccountsRequest) == false) {
            return false;
        }
        GetUserInfoAndAccountsRequest rhs = ((GetUserInfoAndAccountsRequest) other);
