...
public class AddAuthorizedUserRequest extends BaseRequest {

	private static final long serialVersionUID = 8773371272406389578L;
    ...
    public String toString() {
        ...
        sb.append(AddAuthorizedUserRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AddAuthorizedUserRequest) == false) {
            return false;
        }
        AddAuthorizedUserRequest rhs = ((AddAuthorizedUserRequest) other);
