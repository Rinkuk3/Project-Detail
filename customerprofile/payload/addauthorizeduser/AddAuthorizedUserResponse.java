...
public class AddAuthorizedUserResponse extends BaseResponse {

	private static final long serialVersionUID = -7498701006472408622L;
    ...
    public String toString() {
        ...
        sb.append(AddAuthorizedUserResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("status");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AddAuthorizedUserResponse) == false) {
            return false;
        }
        AddAuthorizedUserResponse rhs = ((AddAuthorizedUserResponse) other);
