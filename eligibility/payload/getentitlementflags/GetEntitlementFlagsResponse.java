...
public class GetEntitlementFlagsResponse extends BaseResponse {

	private static final long serialVersionUID = 7674844075609048720L;
    ...
    public String toString() {
        ...
        sb.append(GetEntitlementFlagsResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("status");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GetEntitlementFlagsResponse) == false) {
            return false;
        }
        GetEntitlementFlagsResponse rhs = ((GetEntitlementFlagsResponse) other);
