...
public class GetEntitlementFlagsRequest extends BaseRequest {

	private static final long serialVersionUID = -1514884295359391935L;
    ...
    public String toString() {
        ...
        sb.append(GetEntitlementFlagsRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GetEntitlementFlagsRequest) == false) {
            return false;
        }
        GetEntitlementFlagsRequest rhs = ((GetEntitlementFlagsRequest) other);
