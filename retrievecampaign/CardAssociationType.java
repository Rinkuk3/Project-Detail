...
public class CardAssociationType {
    ...
    public String toString() {
        ...
        sb.append(CardAssociationType.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("typeCd");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CardAssociationType) == false) {
            return false;
        }
        CardAssociationType rhs = ((CardAssociationType) other);
