package com.td.mbna.msec.midtier.offers.payload.requestretailregistration;

import com.td.mbna.msec.midtier.types.common.BaseResponse;

public class RequestRetailRegistrationResponse extends BaseResponse {

	private static final long serialVersionUID = 2262247925208930569L;
    ...
    public String toString() {
        ...
        sb.append(RequestRetailRegistrationResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("status");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RequestRetailRegistrationResponse) == false) {
            return false;
        }
        RequestRetailRegistrationResponse rhs = ((RequestRetailRegistrationResponse) other);
