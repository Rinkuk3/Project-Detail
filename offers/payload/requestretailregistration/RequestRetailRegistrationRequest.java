...
public class RequestRetailRegistrationRequest extends BaseRequest {

	private static final long serialVersionUID = -5979940755489607370L;
    ...
    public String toString() {
        ...
        sb.append(RequestRetailRegistrationRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RequestRetailRegistrationRequest) == false) {
            return false;
        }
        RequestRetailRegistrationRequest rhs = ((RequestRetailRegistrationRequest) other);
