...
public class RequestInstallmentPlanResponse extends BaseResponse {
    ...
    public String toString() {
        ...
        sb.append(RequestInstallmentPlanResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("status");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RequestInstallmentPlanResponse) == false) {
            return false;
        }
        RequestInstallmentPlanResponse rhs = ((RequestInstallmentPlanResponse) other);
