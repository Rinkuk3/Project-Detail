...
public class RequestInstallmentPlanRequest extends BaseRequest {
    ...
    public String toString() {
        ...
        sb.append(RequestInstallmentPlanRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RequestInstallmentPlanRequest) == false) {
            return false;
        }
        RequestInstallmentPlanRequest rhs = ((RequestInstallmentPlanRequest) other);
