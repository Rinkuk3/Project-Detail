...
public class RetrieveOffersRequest extends BaseRequest {

	private static final long serialVersionUID = -6435580715102534397L;
    ...
    public String toString() {
        ...
        sb.append(RetrieveOffersRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RetrieveOffersRequest) == false) {
            return false;
        }
        RetrieveOffersRequest rhs = ((RetrieveOffersRequest) other);
