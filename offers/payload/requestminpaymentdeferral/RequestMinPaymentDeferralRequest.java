...
public class RequestMinPaymentDeferralRequest extends BaseRequest {

	private static final long serialVersionUID = -1322777369427204792L;
    ...
    public String toString() {
        ...
        sb.append(RequestMinPaymentDeferralRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RequestMinPaymentDeferralRequest) == false) {
            return false;
        }
        RequestMinPaymentDeferralRequest rhs = ((RequestMinPaymentDeferralRequest) other);
        return ((((((((((((((this.sessionInfo == rhs.sessionInfo)||((this.sessionInfo!= null)&&this.sessionInfo.equals(rhs.sessionInfo)))&&((this.custInterface == rhs.custInterface)||((this.custInterface!= null)&&this.custInterface.equals(rhs.custInterface))))&&((this.acctNum == rhs.acctNum)||((this.acctNum!= null)&&this.acctNum.equals(rhs.acctNum))))&&((this.requestPayload == rhs.requestPayload)||((this.requestPayload!= null)&&this.requestPayload.equals(rhs.requestPayload))))&&((this.auditInfo == rhs.auditInfo)||((this.auditInfo!= null)&&this.auditInfo.equals(rhs.auditInfo))))&&((this.aliasCustId == rhs.aliasCustId)||((this.aliasCustId!= null)&&this.aliasCustId.equals(rhs.aliasCustId))))&&((this.cardNum == rhs.cardNum)||((this.cardNum!= null)&&this.cardNum.equals(rhs.cardNum))))&&((this.languagePref == rhs.languagePref)||((this.languagePref!= null)&&this.languagePref.equals(rhs.languagePref))))&&((this.custId == rhs.custId)||((this.custId!= null)&&this.custId.equals(rhs.custId))))&&((this.acctType == rhs.acctType)||((this.acctType!= null)&&this.acctType.equals(rhs.acctType))))&&((this.reserved1 == rhs.reserved1)||((this.reserved1 != null)&&this.reserved1 .equals(rhs.reserved1))))&&((this.isMultiCard == rhs.isMultiCard)||((this.isMultiCard!= null)&&this.isMultiCard.equals(rhs.isMultiCard))))&&((this.isPrimaryUser == rhs.isPrimaryUser)||((this.isPrimaryUser!= null)&&this.isPrimaryUser.equals(rhs.isPrimaryUser))));
    }
