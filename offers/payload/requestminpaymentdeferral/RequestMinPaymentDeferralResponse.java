...
public class RequestMinPaymentDeferralResponse extends BaseResponse {

	private static final long serialVersionUID = -1421043423604683601L;
    ...
    public String toString() {
        ...
        sb.append(RequestMinPaymentDeferralResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("status");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RequestMinPaymentDeferralResponse) == false) {
            return false;
        }
        RequestMinPaymentDeferralResponse rhs = ((RequestMinPaymentDeferralResponse) other);
