...
public class RequestCashAdvanceRegistrationRequest extends BaseRequest {

	private static final long serialVersionUID = -8595300637247690299L;
    ...
    public String toString() {
        ...
        sb.append(RequestCashAdvanceRegistrationRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RequestCashAdvanceRegistrationRequest) == false) {
            return false;
        }
        RequestCashAdvanceRegistrationRequest rhs = ((RequestCashAdvanceRegistrationRequest) other);
