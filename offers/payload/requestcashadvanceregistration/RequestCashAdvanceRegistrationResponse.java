package com.td.mbna.msec.midtier.offers.payload.requestcashadvanceregistration;

import com.td.mbna.msec.midtier.types.common.BaseResponse;

public class RequestCashAdvanceRegistrationResponse extends BaseResponse {

	private static final long serialVersionUID = 8913444358156990782L;
    ...
    public String toString() {
        ...
        sb.append(RequestCashAdvanceRegistrationResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("status");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RequestCashAdvanceRegistrationResponse) == false) {
            return false;
        }
        RequestCashAdvanceRegistrationResponse rhs = ((RequestCashAdvanceRegistrationResponse) other);
