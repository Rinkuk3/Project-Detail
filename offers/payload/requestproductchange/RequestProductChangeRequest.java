...
public class RequestProductChangeRequest extends BaseRequest {

	private static final long serialVersionUID = -647179490103912073L;
    ...
    public String toString() {
        ...
        sb.append(RequestProductChangeRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RequestProductChangeRequest) == false) {
            return false;
        }
        RequestProductChangeRequest rhs = ((RequestProductChangeRequest) other);
