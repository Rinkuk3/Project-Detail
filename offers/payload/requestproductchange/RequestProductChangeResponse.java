...
public class RequestProductChangeResponse extends BaseResponse {

	private static final long serialVersionUID = 4722683280984261728L;
    ...
    public String toString() {
        ...
        sb.append(RequestProductChangeResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("status");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RequestProductChangeResponse) == false) {
            return false;
        }
        RequestProductChangeResponse rhs = ((RequestProductChangeResponse) other);
