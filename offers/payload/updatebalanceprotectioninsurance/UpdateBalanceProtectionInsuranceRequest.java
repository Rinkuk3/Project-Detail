...
public class UpdateBalanceProtectionInsuranceRequest extends BaseRequest {

	private static final long serialVersionUID = 2605431431784056420L;
    ...
    public String toString() {
        ...
        sb.append(UpdateBalanceProtectionInsuranceRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof UpdateBalanceProtectionInsuranceRequest) == false) {
            return false;
        }
        UpdateBalanceProtectionInsuranceRequest rhs = ((UpdateBalanceProtectionInsuranceRequest) other);
