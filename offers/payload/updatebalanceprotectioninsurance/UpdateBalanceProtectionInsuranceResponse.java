...
public class UpdateBalanceProtectionInsuranceResponse extends BaseResponse {

	private static final long serialVersionUID = -2917216568339637425L;
    ...
    public String toString() {
        ...
        sb.append(UpdateBalanceProtectionInsuranceResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("status");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof UpdateBalanceProtectionInsuranceResponse) == false) {
            return false;
        }
        UpdateBalanceProtectionInsuranceResponse rhs = ((UpdateBalanceProtectionInsuranceResponse) other);
