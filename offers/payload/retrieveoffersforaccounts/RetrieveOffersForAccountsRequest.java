...
public class RetrieveOffersForAccountsRequest extends BaseRequest {
    
	private static final long serialVersionUID = 6157778990137914661L;
    ...
    public String toString() {
        ...
        sb.append(RetrieveOffersForAccountsRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RetrieveOffersForAccountsRequest) == false) {
            return false;
        }
        RetrieveOffersForAccountsRequest rhs = ((RetrieveOffersForAccountsRequest) other);
