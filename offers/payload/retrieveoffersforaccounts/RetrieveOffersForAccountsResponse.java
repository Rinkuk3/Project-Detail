...
public class RetrieveOffersForAccountsResponse extends BaseResponse {

	private static final long serialVersionUID = 7164575749312579890L;
    ...
    public String toString() {
        ...
        sb.append(RetrieveOffersForAccountsResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("status");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RetrieveOffersForAccountsResponse) == false) {
            return false;
        }
        RetrieveOffersForAccountsResponse rhs = ((RetrieveOffersForAccountsResponse) other);
