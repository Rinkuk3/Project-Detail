...
public class RequestInsuranceRequest extends BaseRequest {

	private static final long serialVersionUID = 2607921686739730770L;
    ...
    public String toString() {
        ...
        sb.append(RequestInsuranceRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RequestInsuranceRequest) == false) {
            return false;
        }
        RequestInsuranceRequest rhs = ((RequestInsuranceRequest) other);
