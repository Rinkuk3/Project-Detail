...
public class RequestInsuranceResponse extends BaseResponse {
	
	private static final long serialVersionUID = -6289771113962421971L;
    ...
    public String toString() {
        ...
        sb.append(RequestInsuranceResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("status");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RequestInsuranceResponse) == false) {
            return false;
        }
        RequestInsuranceResponse rhs = ((RequestInsuranceResponse) other);
