...
public class AlternateFeature {
    ...
    public String toString() {
        ...
        sb.append(AlternateFeature.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("featureId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AlternateFeature) == false) {
            return false;
        }
        AlternateFeature rhs = ((AlternateFeature) other);
