...
public class FinanceChargeFee {
    ...
    public String toString() {
        ...
        sb.append(FinanceChargeFee.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("waiveInd");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FinanceChargeFee) == false) {
            return false;
        }
        FinanceChargeFee rhs = ((FinanceChargeFee) other);
