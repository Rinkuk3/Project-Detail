...
public class OverLimitFee {
    ...
    public String toString() {
        ...
        sb.append(OverLimitFee.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("waiveInd");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof OverLimitFee) == false) {
            return false;
        }
        OverLimitFee rhs = ((OverLimitFee) other);
