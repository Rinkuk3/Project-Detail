...
public class LateFee {
    ...
    public String toString() {
        ...
        sb.append(LateFee.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("waiveInd");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof LateFee) == false) {
            return false;
        }
        LateFee rhs = ((LateFee) other);
