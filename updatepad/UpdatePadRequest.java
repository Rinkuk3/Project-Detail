...
public class UpdatePadRequest extends BaseRequest {
    ...
    public String toString() {
        ...
        sb.append(UpdatePadRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof UpdatePadRequest) == false) {
            return false;
        }
        UpdatePadRequest rhs = ((UpdatePadRequest) other);
