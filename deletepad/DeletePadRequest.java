...
public class DeletePadRequest extends BaseRequest {
    ...
    public String toString() {
        ...
        sb.append(DeletePadRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DeletePadRequest) == false) {
            return false;
        }
        DeletePadRequest rhs = ((DeletePadRequest) other);
