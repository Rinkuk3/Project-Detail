...
public class TsysExtension__1 {
    ...
    public String toString() {
        ...
        sb.append(TsysExtension__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("visa");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TsysExtension__1) == false) {
            return false;
        }
        TsysExtension__1 rhs = ((TsysExtension__1) other);
