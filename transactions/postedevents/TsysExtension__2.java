...
public class TsysExtension__2 {
    ...
    public String toString() {
        ...
        sb.append(TsysExtension__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TsysExtension__2) == false) {
            return false;
        }
        TsysExtension__2 rhs = ((TsysExtension__2) other);
