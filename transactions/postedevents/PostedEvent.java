...
public class PostedEvent {
    ...
    private BigDecimal runningBalanceAmt;
    ...
    private String targetedPromotionIndicatorCd;
    ...
    public TsysExtension__2 getTsysExtension() {
        return tsysExtension;
    }

    public void setTsysExtension(TsysExtension__2 tsysExtension) {
        this.tsysExtension = tsysExtension;
    }

    public String getTargetedPromotionIndicatorCd() {
        return targetedPromotionIndicatorCd;
    }

    public void setTargetedPromotionIndicatorCd(String targetedPromotionIndicatorCd) {
        this.targetedPromotionIndicatorCd = targetedPromotionIndicatorCd;
    }
    ...
    public String toString() {
        ...
        sb.append(',');
        sb.append("targetedPromotionIndicatorCd");
        sb.append('=');
        sb.append(((this.targetedPromotionIndicatorCd == null)?"<null>":this.targetedPromotionIndicatorCd));
        sb.append(',');
        sb.append("startDt");
        sb.append('=');
        sb.append(((this.startDt == null)?"<null>":this.startDt));
        sb.append(',');
        sb.append("startTimeVal");
        sb.append('=');
        sb.append(((this.startTimeVal == null)?"<null>":this.startTimeVal));
        sb.append(',');
    ...
    public int hashCode() {
        ...
        result = ((result* 31)+((this.targetedPromotionIndicatorCd == null)? 0 :this.targetedPromotionIndicatorCd.hashCode()));
        ...
        result = ((result* 31)+((this.startTimeVal == null)? 0 :this.startTimeVal.hashCode()));
        return result;
    }
    ...
    public boolean equals(Object other) {
        ...
        return ((((((((((((((((((((((((((((((((((((((((((((((((((this.disputedInd == rhs.disputedInd)||((this.disputedInd!= null)&&this.disputedInd.equals(rhs.disputedInd)))&&((this.transactionDetailAvailableTypeCd == rhs.transactionDetailAvailableTypeCd)||((this.transactionDetailAvailableTypeCd!= null)&&this.transactionDetailAvailableTypeCd.equals(rhs.transactionDetailAvailableTypeCd))))&&((this.runningBalanceAmt == rhs.runningBalanceAmt)||((this.runningBalanceAmt!= null)&&this.runningBalanceAmt.equals(rhs.runningBalanceAmt))))&&((this.eventDescriptionTxt == rhs.eventDescriptionTxt)||((this.eventDescriptionTxt!= null)&&this.eventDescriptionTxt.equals(rhs.eventDescriptionTxt))))&&((this.authorizationReferenceNum == rhs.authorizationReferenceNum)||((this.authorizationReferenceNum!= null)&&this.authorizationReferenceNum.equals(rhs.authorizationReferenceNum))))&&((this.printedOnStatementInd == rhs.printedOnStatementInd)||((this.printedOnStatementInd!= null)&&this.printedOnStatementInd.equals(rhs.printedOnStatementInd))))&&((this.adjustmentCnt == rhs.adjustmentCnt)||((this.adjustmentCnt!= null)&&this.adjustmentCnt.equals(rhs.adjustmentCnt))))&&((this.eventDttm == rhs.eventDttm)||((this.eventDttm!= null)&&this.eventDttm.equals(rhs.eventDttm))))&&((this.eventId == rhs.eventId)||((this.eventId!= null)&&this.eventId.equals(rhs.eventId))))&&((this.transactionSourceCd == rhs.transactionSourceCd)||((this.transactionSourceCd!= null)&&this.transactionSourceCd.equals(rhs.transactionSourceCd))))&&((this.forcePostedInd == rhs.forcePostedInd)||((this.forcePostedInd!= null)&&this.forcePostedInd.equals(rhs.forcePostedInd))))&&((this.foreignTransactionInd == rhs.foreignTransactionInd)||((this.foreignTransactionInd!= null)&&this.foreignTransactionInd.equals(rhs.foreignTransactionInd))))&&((this.softPostedPaymentInd == rhs.softPostedPaymentInd)||((this.softPostedPaymentInd!= null)&&this.softPostedPaymentInd.equals(rhs.softPostedPaymentInd))))&&((this.acquirerInterbankCardAssociationNum == rhs.acquirerInterbankCardAssociationNum)||((this.acquirerInterbankCardAssociationNum!= null)&&this.acquirerInterbankCardAssociationNum.equals(rhs.acquirerInterbankCardAssociationNum))))&&((this.postedDttm == rhs.postedDttm)||((this.postedDttm!= null)&&this.postedDttm.equals(rhs.postedDttm))))&&((this.centralProcessingDt == rhs.centralProcessingDt)||((this.centralProcessingDt!= null)&&this.centralProcessingDt.equals(rhs.centralProcessingDt))))&&((this.accountingFunctionCd == rhs.accountingFunctionCd)||((this.accountingFunctionCd!= null)&&this.accountingFunctionCd.equals(rhs.accountingFunctionCd))))&&((this.debitCreditCd == rhs.debitCreditCd)||((this.debitCreditCd!= null)&&this.debitCreditCd.equals(rhs.debitCreditCd))))&&((this.targetedPromotionIndicatorCd == rhs.targetedPromotionIndicatorCd)||((this.targetedPromotionIndicatorCd!= null)&&this.targetedPromotionIndicatorCd.equals(rhs.targetedPromotionIndicatorCd))))&&((this.activityTypeDesc == rhs.activityTypeDesc)||((this.activityTypeDesc!= null)&&this.activityTypeDesc.equals(rhs.activityTypeDesc))))&&((this.authorizationReceivedInd == rhs.authorizationReceivedInd)||((this.authorizationReceivedInd!= null)&&this.authorizationReceivedInd.equals(rhs.authorizationReceivedInd))))&&((this.hostCategoryCd == rhs.hostCategoryCd)||((this.hostCategoryCd!= null)&&this.hostCategoryCd.equals(rhs.hostCategoryCd))))&&((this.categoryCd == rhs.categoryCd)||((this.categoryCd!= null)&&this.categoryCd.equals(rhs.categoryCd))))&&((this.fraudInd == rhs.fraudInd)||((this.fraudInd!= null)&&this.fraudInd.equals(rhs.fraudInd))))&&((this.transactionDt == rhs.transactionDt)||((this.transactionDt!= null)&&this.transactionDt.equals(rhs.transactionDt))))&&((this.termBalanceCd == rhs.termBalanceCd)||((this.termBalanceCd!= null)&&this.termBalanceCd.equals(rhs.termBalanceCd))))&&((this.cardNumMasked == rhs.cardNumMasked)||((this.cardNumMasked!= null)&&this.cardNumMasked.equals(rhs.cardNumMasked))))&&((this.acquirerReferenceNum == rhs.acquirerReferenceNum)||((this.acquirerReferenceNum!= null)&&this.acquirerReferenceNum.equals(rhs.acquirerReferenceNum))))&&((this.amt == rhs.amt)||((this.amt!= null)&&this.amt.equals(rhs.amt))))&&((this.chargeBackIndicatorCd == rhs.chargeBackIndicatorCd)||((this.chargeBackIndicatorCd!= null)&&this.chargeBackIndicatorCd.equals(rhs.chargeBackIndicatorCd))))&&((this.statementDt == rhs.statementDt)||((this.statementDt!= null)&&this.statementDt.equals(rhs.statementDt))))&&((this.activityTypeCd == rhs.activityTypeCd)||((this.activityTypeCd!= null)&&this.activityTypeCd.equals(rhs.activityTypeCd))))&&((this.postedAsMemoTransactionInd == rhs.postedAsMemoTransactionInd)||((this.postedAsMemoTransactionInd!= null)&&this.postedAsMemoTransactionInd.equals(rhs.postedAsMemoTransactionInd))))&&((this.cardNum == rhs.cardNum)||((this.cardNum!= null)&&this.cardNum.equals(rhs.cardNum))))&&((this.nonSufficientFundPostedInd == rhs.nonSufficientFundPostedInd)||((this.nonSufficientFundPostedInd!= null)&&this.nonSufficientFundPostedInd.equals(rhs.nonSufficientFundPostedInd))))&&((this.tsysExtension == rhs.tsysExtension)||((this.tsysExtension!= null)&&this.tsysExtension.equals(rhs.tsysExtension))))&&((this.postedEventDetail == rhs.postedEventDetail)||((this.postedEventDetail!= null)&&this.postedEventDetail.equals(rhs.postedEventDetail))))&&((this.approvalCd == rhs.approvalCd)||((this.approvalCd!= null)&&this.approvalCd.equals(rhs.approvalCd))))&&((this.originalCardNum == rhs.originalCardNum)||((this.originalCardNum!= null)&&this.originalCardNum.equals(rhs.originalCardNum))))&&((this.statusCd == rhs.statusCd)||((this.statusCd!= null)&&this.statusCd.equals(rhs.statusCd))))&&((this.transactionSourceDesc == rhs.transactionSourceDesc)||((this.transactionSourceDesc!= null)&&this.transactionSourceDesc.equals(rhs.transactionSourceDesc))))&&((this.classificationCd == rhs.classificationCd)||((this.classificationCd!= null)&&this.classificationCd.equals(rhs.classificationCd))))&&((this.transferredInd == rhs.transferredInd)||((this.transferredInd!= null)&&this.transferredInd.equals(rhs.transferredInd))))&&((this.merchantInfo == rhs.merchantInfo)||((this.merchantInfo!= null)&&this.merchantInfo.equals(rhs.merchantInfo))))&&((this.tdCardsExtension == rhs.tdCardsExtension)||((this.tdCardsExtension!= null)&&this.tdCardsExtension.equals(rhs.tdCardsExtension))))&&((this.translatedInd == rhs.translatedInd)||((this.translatedInd!= null)&&this.translatedInd.equals(rhs.translatedInd))))&&((this.statementDataDt == rhs.statementDataDt)||((this.statementDataDt!= null)&&this.statementDataDt.equals(rhs.statementDataDt))))&&((this.startDt == rhs.startDt)||((this.startDt!= null)&&this.startDt.equals(rhs.startDt))))&&((this.startTimeVal == rhs.startTimeVal)||((this.startTimeVal!= null)&&this.startTimeVal.equals(rhs.startTimeVal))));
    }
