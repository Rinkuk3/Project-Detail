...
public class ChangePinRequest extends BaseRequest {
	...
	private static final long serialVersionUID = 372487675830679573L;
    ...
    public String toString() {
        ...
        sb.append(ChangePinRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ChangePinRequest) == false) {
            return false;
        }
        ChangePinRequest rhs = ((ChangePinRequest) other);
