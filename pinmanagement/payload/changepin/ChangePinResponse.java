...
public class ChangePinResponse extends BaseResponse {
	...
	private static final long serialVersionUID = 72891444461607267L;
    ...
    public String toString() {
        ...
        sb.append(ChangePinResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("status");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ChangePinResponse) == false) {
            return false;
        }
        ChangePinResponse rhs = ((ChangePinResponse) other);
