...
public class GetPinRequest extends BaseRequest {

	private static final long serialVersionUID = 4816507110066419682L;
    ...
    public String toString() {
        ...
        sb.append(GetPinRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GetPinRequest) == false) {
            return false;
        }
        GetPinRequest rhs = ((GetPinRequest) other);
