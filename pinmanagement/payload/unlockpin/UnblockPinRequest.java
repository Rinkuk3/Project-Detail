...
public class UnblockPinRequest extends BaseRequest {

	private static final long serialVersionUID = -3824265240684708110L;
    ...
    public String toString() {
        ...
        sb.append(UnblockPinRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof UnblockPinRequest) == false) {
            return false;
        }
        UnblockPinRequest rhs = ((UnblockPinRequest) other);
