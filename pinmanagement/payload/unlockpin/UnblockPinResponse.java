...
public class UnblockPinResponse extends BaseResponse {

	private static final long serialVersionUID = -5903354939977945823L;
    ...
    public String toString() {
        ...
        sb.append(UnblockPinResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("status");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof UnblockPinResponse) == false) {
            return false;
        }
        UnblockPinResponse rhs = ((UnblockPinResponse) other);
