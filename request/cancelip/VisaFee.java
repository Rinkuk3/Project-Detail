...
public class VisaFee {
    ...
    public String toString() {
        ...
        sb.append(VisaFee.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("reasonCd");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof VisaFee) == false) {
            return false;
        }
        VisaFee rhs = ((VisaFee) other);
