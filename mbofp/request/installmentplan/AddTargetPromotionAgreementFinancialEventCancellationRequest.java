...
public class AddTargetPromotionAgreementFinancialEventCancellationRequest {
    ...
    public String toString() {
        ...
        sb.append(AddTargetPromotionAgreementFinancialEventCancellationRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("reasonCd");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AddTargetPromotionAgreementFinancialEventCancellationRequest) == false) {
            return false;
        }
        AddTargetPromotionAgreementFinancialEventCancellationRequest rhs = ((AddTargetPromotionAgreementFinancialEventCancellationRequest) other);
        return ((((this.solicitationChannelTypeCd == rhs.solicitationChannelTypeCd)||((this.solicitationChannelTypeCd!= null)&&this.solicitationChannelTypeCd.equals(rhs.solicitationChannelTypeCd)))&&((this.accessChannelTypeCd == rhs.accessChannelTypeCd)||((this.accessChannelTypeCd!= null)&&this.accessChannelTypeCd.equals(rhs.accessChannelTypeCd))))&&((this.reasonCd == rhs.reasonCd)||((this.reasonCd!= null)&&this.reasonCd.equals(rhs.reasonCd))));
    }
