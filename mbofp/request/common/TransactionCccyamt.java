package com.td.api.mbofp.request.common;

import java.math.BigDecimal;

public class TransactionCccyamt {
    ...
    public String toString() {
        ...
        sb.append(TransactionCccyamt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("amount");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TransactionCccyamt) == false) {
            return false;
        }
        TransactionCccyamt rhs = ((TransactionCccyamt) other);
