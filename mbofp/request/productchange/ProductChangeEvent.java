...
public class ProductChangeEvent {
    ...
    public String toString() {
        ...
        sb.append(ProductChangeEvent.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ProductChangeEvent) == false) {
            return false;
        }
        ProductChangeEvent rhs = ((ProductChangeEvent) other);
