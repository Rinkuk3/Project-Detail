...
public class ConsentDisclosureRequest extends BaseRequest {

	private static final long serialVersionUID = -6449794905871403643L;
    ...
    public String toString() {
        ...
        sb.append(ConsentDisclosureRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ConsentDisclosureRequest) == false) {
            return false;
        }
        ConsentDisclosureRequest rhs = ((ConsentDisclosureRequest) other);
