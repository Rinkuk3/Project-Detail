...
public class ConsentDisclosureResponse extends BaseResponse {
    ...
    public String toString() {
        ...
        sb.append(ConsentDisclosureResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("status");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ConsentDisclosureResponse) == false) {
            return false;
        }
        ConsentDisclosureResponse rhs = ((ConsentDisclosureResponse) other);
