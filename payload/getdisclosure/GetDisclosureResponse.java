...
public class GetDisclosureResponse extends BaseResponse {

	private static final long serialVersionUID = 6934712655396622086L;
    ...
    public String toString() {
        ...
        sb.append(GetDisclosureResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("status");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GetDisclosureResponse) == false) {
            return false;
        }
        GetDisclosureResponse rhs = ((GetDisclosureResponse) other);
