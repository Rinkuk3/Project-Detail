...
public class GetDisclosureRequest extends BaseRequest {

	private static final long serialVersionUID = -150043773547875881L;
    ...
    public String toString() {
        ...
        sb.append(GetDisclosureRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GetDisclosureRequest) == false) {
            return false;
        }
        GetDisclosureRequest rhs = ((GetDisclosureRequest) other);
