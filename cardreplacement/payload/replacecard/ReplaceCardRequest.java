...
public class ReplaceCardRequest extends BaseRequest {
    ...
    public String toString() {
        ...
        sb.append(ReplaceCardRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ReplaceCardRequest) == false) {
            return false;
        }
        ReplaceCardRequest rhs = ((ReplaceCardRequest) other);
