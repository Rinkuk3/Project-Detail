...
public class ReplaceCardResponse extends BaseResponse {
	...
	private static final long serialVersionUID = -1303860101637738038L;
    ...
    public String toString() {
        ...
        sb.append(ReplaceCardResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("status");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ReplaceCardResponse) == false) {
            return false;
        }
        ReplaceCardResponse rhs = ((ReplaceCardResponse) other);
