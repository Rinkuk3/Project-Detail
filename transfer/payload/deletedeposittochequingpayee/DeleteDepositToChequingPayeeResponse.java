...
public class DeleteDepositToChequingPayeeResponse extends BaseResponse {

	private static final long serialVersionUID = -336283603559890636L;
    ...
    public String toString() {
        ...
        sb.append(DeleteDepositToChequingPayeeResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("status");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DeleteDepositToChequingPayeeResponse) == false) {
            return false;
        }
        DeleteDepositToChequingPayeeResponse rhs = ((DeleteDepositToChequingPayeeResponse) other);
