...
public class DeleteDepositToChequingPayeeRequest extends BaseRequest {

	private static final long serialVersionUID = -8959120266087411943L;
    ...
    public String toString() {
        ...
        sb.append(DeleteDepositToChequingPayeeRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DeleteDepositToChequingPayeeRequest) == false) {
            return false;
        }
        DeleteDepositToChequingPayeeRequest rhs = ((DeleteDepositToChequingPayeeRequest) other);
