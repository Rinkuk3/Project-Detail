...
public class GetBalanceTransferToCreditorPayeesRequest extends BaseRequest {

	private static final long serialVersionUID = 5586261635954213161L;
    ...
    public String toString() {
        ...
        sb.append(GetBalanceTransferToCreditorPayeesRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GetBalanceTransferToCreditorPayeesRequest) == false) {
            return false;
        }
        GetBalanceTransferToCreditorPayeesRequest rhs = ((GetBalanceTransferToCreditorPayeesRequest) other);
