...
public class DepositToChequingResponse extends BaseResponse {

	private static final long serialVersionUID = 8234067615710975034L;
    ...
    public String toString() {
        ...
        sb.append(DepositToChequingResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("status");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DepositToChequingResponse) == false) {
            return false;
        }
        DepositToChequingResponse rhs = ((DepositToChequingResponse) other);
