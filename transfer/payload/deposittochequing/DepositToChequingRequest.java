...
public class DepositToChequingRequest extends BaseRequest {

	private static final long serialVersionUID = 1879646399696497955L;
    ...
    public String toString() {
        ...
        sb.append(DepositToChequingRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DepositToChequingRequest) == false) {
            return false;
        }
        DepositToChequingRequest rhs = ((DepositToChequingRequest) other);
