...
public class GetKnownCardIssuersResponse extends BaseResponse {

	private static final long serialVersionUID = -8995783621594154953L;
    ...
    public String toString() {
        ...
        sb.append(GetKnownCardIssuersResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("status");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GetKnownCardIssuersResponse) == false) {
            return false;
        }
        GetKnownCardIssuersResponse rhs = ((GetKnownCardIssuersResponse) other);
