...
public class GetKnownCardIssuersRequest extends BaseRequest {

	private static final long serialVersionUID = 1402347221275793492L;
    ...
    public String toString() {
        ...
        sb.append(GetKnownCardIssuersRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GetKnownCardIssuersRequest) == false) {
            return false;
        }
        GetKnownCardIssuersRequest rhs = ((GetKnownCardIssuersRequest) other);
