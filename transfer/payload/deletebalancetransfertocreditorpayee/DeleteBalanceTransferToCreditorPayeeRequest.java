...
public class DeleteBalanceTransferToCreditorPayeeRequest extends BaseRequest {

	private static final long serialVersionUID = 3656763444801396766L;
    ...
    public String toString() {
        ...
        sb.append(DeleteBalanceTransferToCreditorPayeeRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DeleteBalanceTransferToCreditorPayeeRequest) == false) {
            return false;
        }
        DeleteBalanceTransferToCreditorPayeeRequest rhs = ((DeleteBalanceTransferToCreditorPayeeRequest) other);
