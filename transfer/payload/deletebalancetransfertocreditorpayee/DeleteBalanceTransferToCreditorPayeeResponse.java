...
public class DeleteBalanceTransferToCreditorPayeeResponse extends BaseResponse {

	private static final long serialVersionUID = 4873965321003610724L;
    ...
    public String toString() {
        ...
        sb.append(DeleteBalanceTransferToCreditorPayeeResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("status");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DeleteBalanceTransferToCreditorPayeeResponse) == false) {
            return false;
        }
        DeleteBalanceTransferToCreditorPayeeResponse rhs = ((DeleteBalanceTransferToCreditorPayeeResponse) other);
