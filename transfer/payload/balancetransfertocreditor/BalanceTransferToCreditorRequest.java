...
public class BalanceTransferToCreditorRequest extends BaseRequest {

	private static final long serialVersionUID = -3811502489768940988L;
    ...
    public String toString() {
        ...
        sb.append(BalanceTransferToCreditorRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof BalanceTransferToCreditorRequest) == false) {
            return false;
        }
        BalanceTransferToCreditorRequest rhs = ((BalanceTransferToCreditorRequest) other);
