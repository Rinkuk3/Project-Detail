...
public class BalanceTransferToCreditorResponse extends BaseResponse {

	private static final long serialVersionUID = -6166576238659130678L;
    ...
    public String toString() {
        ...
        sb.append(BalanceTransferToCreditorResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("status");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof BalanceTransferToCreditorResponse) == false) {
            return false;
        }
        BalanceTransferToCreditorResponse rhs = ((BalanceTransferToCreditorResponse) other);
