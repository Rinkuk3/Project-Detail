...
public class GetDepositToChequingPayeesResponse extends BaseResponse {

	private static final long serialVersionUID = 4231965888592787365L;
    ...
    public String toString() {
        ...
        sb.append(GetDepositToChequingPayeesResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("status");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GetDepositToChequingPayeesResponse) == false) {
            return false;
        }
        GetDepositToChequingPayeesResponse rhs = ((GetDepositToChequingPayeesResponse) other);
