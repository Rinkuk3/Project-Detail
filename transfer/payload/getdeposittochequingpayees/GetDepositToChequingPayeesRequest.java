...
public class GetDepositToChequingPayeesRequest extends BaseRequest {

	private static final long serialVersionUID = -7422277119040602227L;
    ...
    public String toString() {
        ...
        sb.append(GetDepositToChequingPayeesRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GetDepositToChequingPayeesRequest) == false) {
            return false;
        }
        GetDepositToChequingPayeesRequest rhs = ((GetDepositToChequingPayeesRequest) other);
