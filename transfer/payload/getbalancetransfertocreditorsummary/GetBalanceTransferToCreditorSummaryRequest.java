...
public class GetBalanceTransferToCreditorSummaryRequest extends BaseRequest {

	private static final long serialVersionUID = -7438396080091663985L;
    ...
    public String toString() {
        ...
        sb.append(GetBalanceTransferToCreditorSummaryRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GetBalanceTransferToCreditorSummaryRequest) == false) {
            return false;
        }
        GetBalanceTransferToCreditorSummaryRequest rhs = ((GetBalanceTransferToCreditorSummaryRequest) other);
