...
public class AddBalanceTransferToCreditorPayeeResponse extends BaseResponse {

	private static final long serialVersionUID = 5333142032144102558L;
    ...
    public String toString() {
        ...
        sb.append(AddBalanceTransferToCreditorPayeeResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("status");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AddBalanceTransferToCreditorPayeeResponse) == false) {
            return false;
        }
        AddBalanceTransferToCreditorPayeeResponse rhs = ((AddBalanceTransferToCreditorPayeeResponse) other);
