...
public class AddBalanceTransferToCreditorPayeeRequest extends BaseRequest {

	private static final long serialVersionUID = 4464467307818955788L;
    ...
    public String toString() {
        ...
        sb.append(AddBalanceTransferToCreditorPayeeRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AddBalanceTransferToCreditorPayeeRequest) == false) {
            return false;
        }
        AddBalanceTransferToCreditorPayeeRequest rhs = ((AddBalanceTransferToCreditorPayeeRequest) other);
