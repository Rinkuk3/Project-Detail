...
public class UpdateDepositToChequingPayeeResponse extends BaseResponse {

    
	private static final long serialVersionUID = -7760879664617668080L;
    ...
    public String toString() {
        ...
        sb.append(UpdateDepositToChequingPayeeResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("status");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof UpdateDepositToChequingPayeeResponse) == false) {
            return false;
        }
        UpdateDepositToChequingPayeeResponse rhs = ((UpdateDepositToChequingPayeeResponse) other);
