...
public class UpdateDepositToChequingPayeeRequest extends BaseRequest {

	private static final long serialVersionUID = -5162627922575594846L;
    ...
    public String toString() {
        ...
        sb.append(UpdateDepositToChequingPayeeRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof UpdateDepositToChequingPayeeRequest) == false) {
            return false;
        }
        UpdateDepositToChequingPayeeRequest rhs = ((UpdateDepositToChequingPayeeRequest) other);
