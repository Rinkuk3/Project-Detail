...
public class UpdateBalanceTransferToCreditorPayeeRequest extends BaseRequest {

	private static final long serialVersionUID = 3150164144907539392L;
    ...
    public String toString() {
        ...
        sb.append(UpdateBalanceTransferToCreditorPayeeRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof UpdateBalanceTransferToCreditorPayeeRequest) == false) {
            return false;
        }
        UpdateBalanceTransferToCreditorPayeeRequest rhs = ((UpdateBalanceTransferToCreditorPayeeRequest) other);
