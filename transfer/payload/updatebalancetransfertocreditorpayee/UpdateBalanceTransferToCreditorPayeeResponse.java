...
public class UpdateBalanceTransferToCreditorPayeeResponse extends BaseResponse {

	private static final long serialVersionUID = 3142015587966615901L;
    ...
    public String toString() {
        ...
        sb.append(UpdateBalanceTransferToCreditorPayeeResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("status");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof UpdateBalanceTransferToCreditorPayeeResponse) == false) {
            return false;
        }
        UpdateBalanceTransferToCreditorPayeeResponse rhs = ((UpdateBalanceTransferToCreditorPayeeResponse) other);
