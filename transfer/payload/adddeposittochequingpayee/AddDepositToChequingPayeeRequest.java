...
public class AddDepositToChequingPayeeRequest extends BaseRequest {

	private static final long serialVersionUID = 1952997413471208572L;
    ...
    public String toString() {
        ...
        sb.append(AddDepositToChequingPayeeRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AddDepositToChequingPayeeRequest) == false) {
            return false;
        }
        AddDepositToChequingPayeeRequest rhs = ((AddDepositToChequingPayeeRequest) other);
