...
public class BalanceTransferToCreditorPaymentInfoType {
    ...
    public String toString() {
        ...
        sb.append(BalanceTransferToCreditorPaymentInfoType.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("payee");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof BalanceTransferToCreditorPaymentInfoType) == false) {
            return false;
        }
        BalanceTransferToCreditorPaymentInfoType rhs = ((BalanceTransferToCreditorPaymentInfoType) other);
