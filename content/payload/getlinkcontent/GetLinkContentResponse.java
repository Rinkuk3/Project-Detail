...
public class GetLinkContentResponse extends BaseResponse {

	private static final long serialVersionUID = 7968353915536260716L;
    ...
    public String toString() {
        ...
        sb.append(GetLinkContentResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("status");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GetLinkContentResponse) == false) {
            return false;
        }
        GetLinkContentResponse rhs = ((GetLinkContentResponse) other);
