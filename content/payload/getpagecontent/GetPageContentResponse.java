...
public class GetPageContentResponse extends BaseResponse {

	private static final long serialVersionUID = 838594413882268561L;
    ...
    public String toString() {
        ...
        sb.append(GetPageContentResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("status");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GetPageContentResponse) == false) {
            return false;
        }
        GetPageContentResponse rhs = ((GetPageContentResponse) other);
