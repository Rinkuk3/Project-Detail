...
public class BTOfferType implements Serializable {

	private static final long serialVersionUID = -7373560946191837584L;
    ...
    public String toString() {
        ...
        sb.append(BTOfferType.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("rate");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof BTOfferType) == false) {
            return false;
        }
        BTOfferType rhs = ((BTOfferType) other);
