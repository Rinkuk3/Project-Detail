...
public class PromotionTerm {
    ...
    public String toString() {
        ...
        sb.append(PromotionTerm.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PromotionTerm) == false) {
            return false;
        }
        PromotionTerm rhs = ((PromotionTerm) other);
