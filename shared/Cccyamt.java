...
public class Cccyamt {
    ...
    public String toString() {
        ...
        sb.append(Cccyamt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("amount");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Cccyamt) == false) {
            return false;
        }
        Cccyamt rhs = ((Cccyamt) other);
