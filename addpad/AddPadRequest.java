...
public class AddPadRequest extends BaseRequest {
    ...
    public String toString() {
        ...
        sb.append(AddPadRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AddPadRequest) == false) {
            return false;
        }
        AddPadRequest rhs = ((AddPadRequest) other);
