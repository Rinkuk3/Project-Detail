...
public class ActivateCardResponse extends BaseResponse {

	private static final long serialVersionUID = -1301363515694776025L;
    ...
    public String toString() {
        ...
        sb.append(ActivateCardResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("status");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ActivateCardResponse) == false) {
            return false;
        }
        ActivateCardResponse rhs = ((ActivateCardResponse) other);
