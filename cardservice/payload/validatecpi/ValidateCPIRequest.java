...
public class ValidateCPIRequest extends BaseRequest {

	private static final long serialVersionUID = -5893441600890231535L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ValidateCPIRequest) == false) {
            return false;
        }
        ValidateCPIRequest rhs = ((ValidateCPIRequest) other);
        return ((((((((((((this.getSessionInfo() == rhs.getSessionInfo())||((this.getSessionInfo()!= null)&&this.getSessionInfo().equals(rhs.getSessionInfo())))&&((this.getAuditInfo() == rhs.getAuditInfo())||((this.getAuditInfo()!= null)&&this.getAuditInfo().equals(rhs.getAuditInfo()))))&&((this.getAliasCustId() == rhs.getAliasCustId())||((this.getAliasCustId()!= null)&&this.getAliasCustId().equals(rhs.getAliasCustId()))))&&((this.getCustInterface() == rhs.getCustInterface())||((this.getCustInterface()!= null)&&this.getCustInterface().equals(rhs.getCustInterface()))))&&((this.getLanguagePref() == rhs.getLanguagePref())||((this.getLanguagePref()!= null)&&this.getLanguagePref().equals(rhs.getLanguagePref()))))&&((this.getAcctNum() == rhs.getAcctNum())||((this.getAcctNum()!= null)&&this.getAcctNum().equals(rhs.getAcctNum()))))&&((this.requestPayload == rhs.getRequestPayload())||((this.requestPayload!= null)&&this.requestPayload.equals(rhs.requestPayload))))&&((this.getCustId() == rhs.getCustId())||((this.getCustId()!= null)&&this.getCustId().equals(rhs.getCustId()))))&&((this.getAcctType() == rhs.getAcctType())||((this.getAcctType()!= null)&&this.getAcctType().equals(rhs.getAcctType()))))&&((this.getReserved1() == rhs.getReserved1())||((this.getReserved1() != null)&&this.getReserved1() .equals(rhs.getReserved1()))))&&((this.getIsPrimaryUser() == rhs.getIsPrimaryUser())||((this.getIsPrimaryUser()!= null)&&this.getIsPrimaryUser().equals(rhs.getIsPrimaryUser()))));
    }
}
