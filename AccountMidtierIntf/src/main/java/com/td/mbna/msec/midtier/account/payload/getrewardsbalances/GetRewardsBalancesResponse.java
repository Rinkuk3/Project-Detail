...
public class GetRewardsBalancesResponse extends BaseResponse {

	private static final long serialVersionUID = 8407811038142753107L;
	
//	@SerializedName("ResponsePayload")
	private ResponsePayload responsePayload;

	public GetRewardsBalancesResponse() {
    ...
    public String toString() {
        ...
        sb.append(GetRewardsBalancesResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("status");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GetRewardsBalancesResponse) == false) {
            return false;
        }
        GetRewardsBalancesResponse rhs = ((GetRewardsBalancesResponse) other);
