...
public class GetRewardsSamlResponse extends BaseResponse {

	private static final long serialVersionUID = 3846526159713288580L;
	
//	@SerializedName("ResponsePayload")
	private ResponsePayload responsePayload;

	public GetRewardsSamlResponse() {
    ...
    public String toString() {
        ...
        sb.append(GetRewardsSamlResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("status");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GetRewardsSamlResponse) == false) {
            return false;
        }
        GetRewardsSamlResponse rhs = ((GetRewardsSamlResponse) other);
