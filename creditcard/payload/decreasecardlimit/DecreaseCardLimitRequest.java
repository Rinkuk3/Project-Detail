...
public class DecreaseCardLimitRequest extends BaseRequest {

	private static final long serialVersionUID = 3838636602906514415L;
    ...
    public String toString() {
        ...
        sb.append(DecreaseCardLimitRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DecreaseCardLimitRequest) == false) {
            return false;
        }
        DecreaseCardLimitRequest rhs = ((DecreaseCardLimitRequest) other);
