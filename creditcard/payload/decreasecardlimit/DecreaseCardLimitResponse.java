...
public class DecreaseCardLimitResponse extends BaseResponse {

	private static final long serialVersionUID = 1907151621425666401L;
    ...
    public String toString() {
        ...
        sb.append(DecreaseCardLimitResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("status");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DecreaseCardLimitResponse) == false) {
            return false;
        }
        DecreaseCardLimitResponse rhs = ((DecreaseCardLimitResponse) other);
