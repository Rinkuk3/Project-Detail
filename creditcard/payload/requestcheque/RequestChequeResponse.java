...
public class RequestChequeResponse extends BaseResponse {

	private static final long serialVersionUID = 590585070474134187L;
    ...
    public String toString() {
        ...
        sb.append(RequestChequeResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("status");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RequestChequeResponse) == false) {
            return false;
        }
        RequestChequeResponse rhs = ((RequestChequeResponse) other);
