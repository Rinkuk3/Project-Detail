...
public class RequestChequeRequest extends BaseRequest {

	private static final long serialVersionUID = 2008480723216177292L;
    ...
    public String toString() {
        ...
        sb.append(RequestChequeRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RequestChequeRequest) == false) {
            return false;
        }
        RequestChequeRequest rhs = ((RequestChequeRequest) other);
