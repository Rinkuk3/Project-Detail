...
public class IncreaseCardLimitRequest extends BaseRequest {
    
	private static final long serialVersionUID = 5324515314283934175L;
    ...
    public String toString() {
        ...
        sb.append(IncreaseCardLimitRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof IncreaseCardLimitRequest) == false) {
            return false;
        }
        IncreaseCardLimitRequest rhs = ((IncreaseCardLimitRequest) other);
