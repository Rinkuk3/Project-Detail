...
public class ValidateBankAccountRequest extends BaseRequest {
    ...
    public String toString() {
        ...
        sb.append(ValidateBankAccountRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ValidateBankAccountRequest) == false) {
            return false;
        }
        ValidateBankAccountRequest rhs = ((ValidateBankAccountRequest) other);
