...
public class CardWatch {
    ...
    public String toString() {
        ...
        sb.append(CardWatch.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("statusCd");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CardWatch) == false) {
            return false;
        }
        CardWatch rhs = ((CardWatch) other);
